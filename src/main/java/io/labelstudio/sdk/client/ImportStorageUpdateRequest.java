...
/**
 * Request object for updating import storage configurations.
 */
public class ImportStorageUpdateRequest {
    ...
    private ImportStorageUpdateRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public ImportStorageUpdateRequest build() {
            return new ImportStorageUpdateRequest(this);
        }
    }
}