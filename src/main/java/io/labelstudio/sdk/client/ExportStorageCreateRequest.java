...
/**
 * Request object for creating export storage configurations.
 */
public class ExportStorageCreateRequest {
    ...
    private ExportStorageCreateRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public ExportStorageCreateRequest build() {
            return new ExportStorageCreateRequest(this);
        }
    }
}